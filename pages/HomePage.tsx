    ...
    <div className="space-y-12">
      <div className="text-center">
        <div className="flex justify-center items-center gap-4 mb-4">
          <img src="/media/logo_SENA.png" alt="SENA Logo" className="h-12 sm:h-16" />
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-2">
        <Link to="/evidences" className="group block bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden md:col-span-2">
          <div className="overflow-hidden">
            <img src="https://picsum.photos/seed/person-studying-english/800/400" alt="A person studying English" className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" />
          </div>
          <div className="p-6">
